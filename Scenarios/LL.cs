...
namespace WebCrawler.Scenarios
{
    public static class LL
    {
        public static async Task Download()
        {
            ...
            Regex comicImageMatcher = new Regex("id=\"comic\"[\\w\\W]{1,400}<img src=\\\"(.+?)\\\"[^>]+?title=\\\"(.+?)\\\"");
            Uri currentUrl = new Uri("https://laslindas.kemono.cafe/comic/return-of-an-era/");
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    string fileName = string.Format("{0:D4} - {1}.jpg", comicPage, comicTitle);
