...
{
    public static class Tamberlane
    {
        public static async Task Download()
        {
            ...
            Regex nextPageLinkMatcher = new Regex("<a href=\"(.+?)\" class=\"next-link\">Next</a>");
            Regex comicImageMatcher = new Regex("<img src=\"(.+?)\" title=\"(.+?)\" usemap=\"#comicpage\" */>");
            Uri currentUrl = new Uri("https://www.tamberlanecomic.com/comic/381/#comic-page");
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    string comicTitle = WebUtility.HtmlDecode(comicImageMatch.Groups[2].Value);
                    ...
                    string imageUrl = "https://www.tamberlanecomic.com" + comicImageMatch.Groups[1].Value;
                    ...
                    {
                        currentUrl = new Uri("https://www.tamberlanecomic.com" + nextPageLinkMatch.Groups[1].Value);
                    }
                }
                catch (Exception e)
                {
